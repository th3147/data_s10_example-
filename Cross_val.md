...
![](Cross_val_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
- When applied in statistics (regression analysis), a piecewise model,
  often called segmented regression or broken-line regression, is used
  when the data clearly shows a change in trend at a specific point.
...
![](Cross_val_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
...
![](Cross_val_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->
...
- A tighter distribution around its mean than the wiggly model,
